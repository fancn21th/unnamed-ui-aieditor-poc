...
interface MarkdownSnapshotBubbleMenuProps {
  editor: Editor;
...
export function MarkdownSnapshotBubbleMenu({
  editor,
  lockableNodeTypes,
}: MarkdownSnapshotBubbleMenuProps) {
  ...
  return (
    ...
    >
      <div className="markdown-snapshot-context-menu">
        <Button
          type="button"
          variant="ghost"
          onClick={handleBold}
