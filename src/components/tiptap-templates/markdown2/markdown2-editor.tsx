...
import "@/components/tiptap-templates/markdown2/markdown2-editor.scss";
...
export function Markdown2Editor() {
  ...
  return (
    <div className="markdown2-editor-wrapper">
